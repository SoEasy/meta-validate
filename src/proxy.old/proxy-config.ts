...
import { ProxyValidator, ProxyValidationResult, PartialValidityMeta } from 'proxy/interfaces';
...
export class ProxyConfig {
    ...
    private validationCb: (validationResult: ProxyValidationResult) => void;
    private partialValidityStore: Record<string, PartialValidityMeta> = {};
